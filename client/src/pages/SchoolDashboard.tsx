...
const Dashboard: React.FC = () => {
  ...
  const [transactions] = useState<Transaction[]>([
    { id: '1', date: '2025-05-12', description: 'School Fees Payment - John Doe', amount: 25000, type: 'credit' },
    { id: '2', date: '2025-05-10', description: 'Book Store Purchase', amount: 5000, type: 'debit' },
    { id: '3', date: '2025-05-07', description: 'School Fees Payment - Jane Smith', amount: 30000, type: 'credit' },
    { id: '4', date: '2025-05-05', description: 'Stationery Supplies', amount: 7500, type: 'debit' },
  ]);
...
const fetchUserDetails: FetchUserDetails = useCallback(async (authToken: string): Promise<User> => {
  try {
  ...
  (async () => {
    try {
      ...
      const [stu, store, wallet] = await Promise.all([
        fetch(`${API_BASE_URL}/api/users/getstudentbyidcount?id=${user._id}`, { 
      ...
      if (!wallet.ok) throw new Error(`Wallet fetch failed: ${wallet.status}`);
      ...
      setSnackbar({ open: true, message: 'Data loaded', severity: 'success' });
    } catch (error) {
       ...
       <main className="flex-grow p-4 md:p-8 md:ml-64">
          ...
          <div className="mb-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-indigo-900">School Dashboard</h1>
                <p className="text-gray-600">Welcome back, {user && user.name ? user.name : 'Administrator'}</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-800">₦{stats.walletBalance.toLocaleString()}</p>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-800">{stats.totalStores.toLocaleString()}</p>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
                  ...
                  <div className="overflow-y-auto max-h-72">
                    {transactions.length > 0 ? (
                      ...
                      <p className="text-sm text-gray-600 text-center py-8">No transactions available.</p>
                    )}
                  </div>
                </div>
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
            ...
            <>
              ...
              <div className="grid grid-cols-1 gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
                    <h3 className="text-lg font-semibold text-gray-800 mb-3">Top Paying Class</h3>
                    <div className="space-y-3">
                  ...
                  <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
                    <h3 className="text-lg font-semibold text-gray-800 mb-3">Fee Collection Status</h3>
                    ...
                    <div className="mt-4 text-center">
                      <p className="text-sm text-gray-600">Total Expected: ₦1,200,000</p>
                      <p className="text-sm text-gray-600">Collected: ₦900,000</p>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <div className="flex items-start">
                          <div className="p-2 bg-indigo-100 rounded mr-3 text-center">
                            <p className="text-xs text-indigo-800 font-bold">MAY</p>
                            <p className="text-lg text-indigo-800 font-bold">15</p>
                          </div>
                          <div>
                      ...
                      <div>
                        <div className="flex items-start">
                          <div className="p-2 bg-indigo-100 rounded mr-3 text-center">
                            <p className="text-xs text-indigo-800 font-bold">MAY</p>
                            <p className="text-lg text-indigo-800 font-bold">20</p>
                          </div>
                          <div>
                            <p className="font-medium text-gray-800">Inter-School Sports</p>
                      ...
                      <div>
                        <div className="flex items-start">
                          <div className="p-2 bg-indigo-100 rounded mr-3 text-center">
                            <p className="text-xs text-indigo-800 font-bold">MAY</p>
                            <p className="text-lg text-indigo-800 font-bold">25</p>
                          </div>
                          <div>
                            <p className="font-medium text-gray-800">Cultural Day</p>
        ...
        >
          <div className="flex items-center">
            <div className={`p-2 rounded-full mr-3 ${
              snackbar.severity === 'success' ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'
            }`}>
